...
const char *enrollmentResultUrl = "http://10.25.167.198:3000/api/device/enrollment/result";
const char *migrationNextUrl = "http://10.25.167.198:3000/api/device/migration/next";
const char *migrationResultUrl = "http://10.25.167.198:3000/api/device/migration/result";
const char *deleteNextUrl = "http://10.25.167.198:3000/api/device/delete/next";
const char *deleteResultUrl = "http://10.25.167.198:3000/api/device/delete/result";
const char *sensorClearNextUrl = "http://10.25.167.198:3000/api/device/sensor/clear/next";
const char *sensorClearResultUrl = "http://10.25.167.198:3000/api/device/sensor/clear/result";
